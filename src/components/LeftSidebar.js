...
export const LeftSidebar = ({ user_data, togglePopup, showPopup, post }) => {
  return (
    <div
      className={`${
        showPopup && "z-0"
      } md:block fixed top-24 mb-2 left-0 w-1/5 xl:w-1/5 2xl:w-1/5 2xl:ms-10 lg:w-1/4 md:w-[32vw]  md:ms-5 lg:ms-5 xl:ms-10 ms-10 h-fit`}
    >
