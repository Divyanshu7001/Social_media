...
export const LeftSidebar = ({ user_data, togglePopup, showPopup, post }) => {
  return (
    <div
      className={`${
        showPopup && "z-0"
      } md:block fixed top-24  mb-2 left-0 w-1/5 xl:w-1/5 2xl:w-1/5 2xl:ms-10 lg:w-1/4 md:w-3/12  md:ms-5 lg:ms-5 xl:ms-10 ms-10  h-fit`}
    >
      <div className=" bg-white rounded border-2 h-4/5 hidden md:flex lg:flex flex-col w-full px-8 mt-0.5 md:mt-0.5 lg:mt-3.5  md:px-1 lg:px-8 py-5">
        ...
        {/* Sidebar Links */}
        <div className="flex flex-col justify-around h-4/5  mb-2 px-0 md:px-2 lg:px-0 xl:space-y-8">
