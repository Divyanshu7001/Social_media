      ...
      <div className="flex px-5 md:px-0 ms-auto w-full lg:w-[68%] md:w-[65%] xl:w-[68%] 2xl:w-[68%] min-h-screen me-[3%] lg:me-[2%] xl:me-[6%] 2xl:me-[6%] my-7">
        ...
        <div className="w-full">
          ...
          <div className='flex gap-5 w-full justify-center rounded'>
            <button className={`px-3 py-1 mb-2 w-1/3 font-bold border-b-2 text-2xl ${btn === "article" ? "border-gray-500 text-gray-500" : "border-primary  text-primary"}`} onClick={() => setBtn("article")}>Articles</button>
            <button className={`px-3 py-1 mb-2 w-1/3 font-bold border-b-2 text-2xl ${btn === "post" ? "border-gray-500  text-gray-500" : "border-primary text-primary "}`} onClick={() => setBtn("post")}>Post</button>
          </div>
