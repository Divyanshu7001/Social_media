        ...
        <div className="w-[90%] mx-auto mt-[2vw] flex justify-between">
          ...
          <div className="w-[80%]">
            ...
            <div className="relative">
              <img className="absolute top-3 left-3 h-[1.5vw] w-[1.5vw]" src="./images/carbonSearch.png" />
              <input className="w-[40vw] border-[1.5px] placeholder:font-thin border-black py-2 pl-[3vw] rounded-[9px] border-opacity-20" placeholder='Search for Journals' />
            </div>

            <div className="relative mt-[1vw] w-[63vw] flex gap-[1.5vw] p-5 h-[15vw] rounded-[9px] border-opacity-20 border-[1.5px] border-black">
              <button className="bg-[#0000FF] text-white font-semibold text-sm py-[0.5vw] px-[1.5vw] rounded-[4px] bottom-4 right-4 absolute">View More </button>
              <div className="">
              ...
              <div className="leading-[2.5vw]">
                ...
                <h3 className="opacity-50">Publications:                Citations:                Conferences/Seminar:          </h3>
