...
const Modal1 = ({setbutton1Clicked}) => {
  return (
    <div onClick={() => setbutton1Clicked(false)} className='h-full w-screen absolute bg-black bg-opacity-60'>
        <div  onClick={(e) => e.stopPropagation()} className='min-h-screen p-[2vw] bg-white rounded-xl  w-[80%] mt-[5vw] mx-auto'>
            ...
            <div className='bg-white'>
                ...
                <RxCross2 onClick={() => setbutton1Clicked(false)}   className='text-2xl'/>
                </div>
                <hr className='my-[1vw]'/>
                ...
                <div className='flex flex-row gap-[1vw] mt-[4vw]'>
                    ...
                    <button onClick={() => setbutton1Clicked(false)} className=' rounded-md px-[6.5vw] py-2 text-[#0000FF]  font-medium bg-transparent border-[#0000FF] border-[1.5px]'>Cancel</button>
                </div>
            </div>
