  ...
  return (
    <div className="group-24">
      <div className="overlap-5">
        ...
        <div className="group-25" onClick={() => navigate("/connections")}>
          <img className="img-3" alt="Fluent people" src="path/to/fluentpeople24regular" />
          <div className="text-wrapper-41">My Connections</div>
        </div>

        <div className="group-26" onClick={() => navigate("/notifications")}>
          <img className="img-3" alt="Clarity notification" src="path/to/claritynotificationline" />
        ...
        <div className="group-28" onClick={() => navigate("/messages")}>
          <img className="img-3" alt="Material symbols" src="path/to/materialsymbolslightchatoutline" />
        ...
        <div className="group-30" onClick={() => navigate("/saved-items")}>
          <img className="img-3" alt="Iconamoon bookmark" src="path/to/iconamoonbookmarkthin" />
