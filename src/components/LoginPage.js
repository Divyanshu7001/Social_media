...
const LoginPage = () => {
  ...
  const handleVerifyOtp = () => {
    if (otp === '123456') { // For demo, use a static OTP
  ...
  return (
    <div style={loginContainerStyle}>
      ...
      {!forgotPassword && (
        <div style={formStyle}>
          ...
          <div style={socialLoginContainerStyle}>
            <button style={socialLoginBtnStyle} onClick={() => window.location.href = 'https://accounts.google.com/o/oauth2/auth'}>
              <FontAwesomeIcon icon={faGoogle} /> Login with Google
            </button>
            <button style={socialLoginBtnStyle} onClick={() => window.location.href = 'https://www.facebook.com/v11.0/dialog/oauth'}>
              <FontAwesomeIcon icon={faFacebook} /> Login with Facebook
            </button>
          </div>

          <button style={socialLoginBtnStyleApple} onClick={() => window.location.href = 'https://appleid.apple.com/auth/authorize'}>
          ...
          {!otpSent ? (
            <>
              <input
                ...
                style={inputStyle}
              />
              <button style={loginBtnStyle} onClick={handleSendOtp}>Send OTP</button>
            </>
          ) : !otp ? (
            <>
              <input
                ...
                style={inputStyle}
              />
              <button style={loginBtnStyle} onClick={handleVerifyOtp}>Verify OTP</button>
            </>
          ) : (
            <>
              <input
                ...
                style={inputStyle}
              />
              <button style={loginBtnStyle} onClick={handleResetPassword}>Reset Password</button>
            </>
          )}
        </div>
      )}
      ...
      <div style={imageStyle}>
        <img src={imageUrl} alt="Login" style={{ width: '100%', height: 'auto' }} />
      </div>
    </div>
  );
};
